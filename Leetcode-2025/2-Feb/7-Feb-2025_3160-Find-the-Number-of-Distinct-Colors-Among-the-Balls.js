...
/**
 * ================================
 * 🏀 queryResults Function Dry Run
 * ================================
 * The function tracks the number of unique colors used by balls over time.
 * Each ball can only have one color at a time.
 * If a ball changes color, the previous color count decreases.
 * If a color is no longer used by any ball, it is removed from the map.
 *
 * ---------------------------------------------------
 * 🌟 Test Case 1:
 * Input: [[1,4], [2,5], [1,3], [3,4]]
 * ----------------------------------------------------------------
 * | Step | Query  | Ball Map      | Color Map     | Unique Colors |
 * |------|--------|---------------|---------------|---------------|
 * | 1    | [1,4]  | {1:4}         | {4:1}         | 1             |
 * | 2    | [2,5]  | {1:4,2:5}     | {4:1,5:1}     | 2             |
 * | 3    | [1,3]  | {1:3,2:5}     | {5:1,3:1}     | 2             |
 * | 4    | [3,4]  | {1:3,2:5,3:4} | {5:1,3:1,4:1} | 3             |
 * Output: [1, 2, 2, 3]
 *
 * ---------------------------------------------------
 * 🌟 Test Case 2:
 * Input: [[0,1], [1,2], [2,2], [3,4], [4,5]]
 * ----------------------------------------------------------------------------
 * | Step | Query  | Ball Map              | Color Map         | Unique Colors |
 * |------|--------|-----------------------|-------------------|---------------|
 * | 1    | [0,1]  | {0:1}                 | {1:1}             | 1             |
 * | 2    | [1,2]  | {0:1,1:2}             | {1:1,2:1}         | 2             |
 * | 3    | [2,2]  | {0:1,1:2,2:2}         | {1:1,2:2}         | 2             |
 * | 4    | [3,4]  | {0:1,1:2,2:2,3:4}     | {1:1,2:2,4:1}     | 3             |
 * | 5    | [4,5]  | {0:1,1:2,2:2,3:4,4:5} | {1:1,2:2,4:1,5:1} | 4             |
 * Output: [1, 2, 2, 3, 4]
 *
 * ---------------------------------------------------
 * 🌟 Test Case 3:
 * Input: [[0,2], [1,10], [0,10], [0,3], [1,5]]
 * -----------------------------------------------------------------
 * | Step | Query  | Ball Map        | Color Map    | Unique Colors |
 * |------|--------|-----------------|--------------|---------------|
 * | 1    | [0,2]  | {0:2}           | {2:1}        | 1             |
 * | 2    | [1,10] | {0:2,1:10}      | {2:1,10:1}   | 2             |
 * | 3    | [0,10] | {0:10,1:10}     | {10:2}       | 1             |
 * | 4    | [0,3]  | {0:3,1:10}      | {10:1,3:1}   | 2             |
 * | 5    | [1,5]  | {0:3,1:5}       | {3:1,5:1}    | 2             |
 * Output: [1, 2, 1, 2, 2]
 *
 * 🎯 Summary:
 * - The function keeps track of colors assigned to balls.
 * - If a ball changes color, it updates the color count accordingly.
 * - The final result is the **number of unique colors** after each operation.
 */
